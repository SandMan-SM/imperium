...
export default function ShopPage() {
    return (
        <div className="min-h-screen bg-imperium-bg">
            {/* Hero */}
            <div className="relative border-b border-imperium-border pt-[72px] pb-10 sm:pb-14 text-center overflow-hidden">
                ...
                <div className="relative container mx-auto px-4 sm:px-6">
                    ...
                    <h1 className="text-2xl sm:text-3xl md:text-6xl text-white mb-3 sm:mb-4 leading-tight">

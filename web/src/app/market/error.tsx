    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black pt-[84px] flex items-center justify-center">
            <div className="text-center max-w-md px-4">
                ...
                <h2 className="text-2xl font-serif text-white mb-4">Market Error</h2>
                <p className="text-gray-400 mb-8">Something went wrong loading the market. Please try again.</p>
                <button
                    onClick={reset}
